/**
 * French Wikipedia access: fetch a year page's wikitext, pull out its
 * "Événements" (and, for future years, "Événements prévus"-style) section,
 * and fetch a short plain-text summary for a specific article on demand.
 *
 ...
 */
import { extractSection, parseBulletLines, type ParsedBullet } from "./wikitext";
...
/** Returns every parsed event bullet for a given year (historical +, when
 * present, planned/future section), from cache when available. */
